...
import { pickPhotoMessage, pickProfilePhoto } from '@/services/photoPicker';
import {
  EDUCATION_OPTIONS,
  FREQUENCY_OPTIONS,
  GOAL_OPTIONS,
...
export default function EditProfile() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      {/* Le clavier ne doit pas recouvrir le champ actif (bio, taille,
          profession), et un appui sur un bouton reste un appui même clavier
          ouvert. */}
      <KeyboardAvoidingView
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <SectionCard title="Je recherche" style={styles.section}>
          ...
          <Text style={styles.hint}>
            {"La tranche d'âge et le genre recherchés se règlent dans Paramètres, Préférences de recherche."}
          </Text>
        </SectionCard>

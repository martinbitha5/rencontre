-- Le retour de send_direct_message indique désormais si le message est parti
-- dans une conversation déjà existante (already_matched) : dans ce cas il n'y
-- a pas d'invitation "en attente" à afficher dans DMs > Envoyés, le message
-- est dans la conversation normale.
